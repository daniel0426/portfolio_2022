  ...
  return (
    <section className="container mx-auto py-12 px-2" id="projects">
      ...
      <div className="flex flex-col mx-auto w-4/5 sm:w-full md:flex-row justify-center sm:grid-cols-2 items-start ">
        <div className="font-light mx-auto pt-7 md:px-12 sm:w-1/2  relative flex flex-col min-h-full">
          ...
          {projects.map((project) => (
            ...
            >
              <div className="cursor-pointer mb-4 sm:mb-0 flex flex-col group ">
                <p className="text-5xl sm:text-8xl  lg:text-9xl text-purple  font-machine opacity-85 hover:opacity-100 hover:brightness-125  hover:italic hover:translate-x-3 transition-all">
                  {project.title}
                </p>
